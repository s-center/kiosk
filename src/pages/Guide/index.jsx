...
export const Guide = () => {
    ...
    return (<>
        ...
        left: 35%; 
        font-size: 200%; 
        text-shadow: 5px 5px 20px rgb(255,255,255);`}>디퓨저를 배치하고 싶은</p>
                <p css={css`
      color:rgb(255,255,255); 
      position: relative; 
      top :51%; 
      left: 38%; 
      font-size: 200%; 
      text-shadow: 5px 5px 20px rgb(255,255,255);`}>장소를 선택합니다</p></div>
        )}
        ...
        left: 35%; 
        font-size: 200%; 
        text-shadow: 5px 5px 20px rgb(255,255,255);`}>디퓨저 병을 감싸줄</p>
                <p css={css`
      color:rgb(255,255,255); 
      position: relative; 
      top :51%; 
      left: 38%; 
      font-size: 200%; 
      text-shadow: 5px 5px 20px rgb(255,255,255);`}>색을 선택합니다</p></div>
        )}
        ...
        left: 35%; 
        font-size: 200%; 
        text-shadow: 5px 5px 20px rgb(255,255,255);`}>디퓨저에 넣고싶은</p>
                    <p css={css`
      color:rgb(255,255,255); 
      position: relative; 
      top :51%; 
      left: 38%; 
      font-size: 200%; 
      text-shadow: 5px 5px 20px rgb(255,255,255);`}>향을 선택합니다</p></div></Link>
        )}
